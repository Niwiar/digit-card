...
function take_snapshot() {
  Webcam.snap(function (data_url) {
    document.getElementById("results").innerHTML = '<img id="imageprev" class="cropped1" src="' + data_url + '"/>';
  });
...
$(document).ready(function () {
  $("#btnConfirmImg").on("click", () => {
    let dataUrl = $("#mobileImg").attr("src");
    console.log(dataUrl.includes("/imgs/profile"));

    if (!dataUrl.includes("/imgs/profile")) {
      let blob = dataURItoBlob(dataUrl);
      ...
      closeCamera();
        ...
        Swal.fire({
            ...
            icon: "warning",
            title: "Warning",
            text: "รูปภาพไม่มีการเปลี่ยนแปลง",
            showConfirmButton: true,
            confirmButtonText: "OK",
            confirmButtonColor: "#FF5733",
        })
